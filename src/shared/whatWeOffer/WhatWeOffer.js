...
const WhatWeOffer = () => {
  ...
  return (
    <div id="whatweoffer" className="whatweoffer">
      <h1 className="whatweoffer-heading">What We Offer</h1>
      <div className="icon-container">
        <div className="icon-div" onClick={() => navigate("/about/rhis")}>
          <div data-aos="flip-left">
            ...
            <p style={{ textAlign: "center" }}>Professional Teachers</p>
          </div>
        </div>
        <div
          className="icon-div"
        ...
        >
          <div data-aos="flip-left">
            ...
            <p style={{ textAlign: "center" }}>Our Approach</p>
          </div>
        </div>
        <div
          className="icon-div"
          onClick={() => navigate("/academics/academic-program")}
        >
          <div data-aos="flip-left">
            <AiOutlineStar style={{ fontSize: "100px" }} />
            <p style={{ textAlign: "center" }}>Education Programs</p>
          </div>
        </div>
